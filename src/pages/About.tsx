    ...
    <Element name="about">
      <section className="lg:w-10/12 md:w-11/12 sm:w-9/12 w-10/12 m-auto pb-64">
        ...
        <div className="mt-5 max-w-2xl text-justify primary-text text-lg">
          Furthermore, I like to keep learning with online courses from Udemy or
          Youtube, as I love to learn new technologies. Some of the technologies that I am trying to learn next are: Next.js, Qwick and Python.
        </div>
      </section>
    </Element>
  );
